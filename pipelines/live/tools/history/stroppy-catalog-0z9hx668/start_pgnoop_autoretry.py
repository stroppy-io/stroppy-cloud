...
p=Path('/tmp/stroppy-catalog-0z9hx668');old=p/'auxiliary';dest=p/'pg-noop-autoretry';cli='/tmp/stroppy-clusters-r1gx3otm/bin/graphenectl'
...
v=json.loads((dest/'suite.json').read_text());assert v['concurrency']==1 and len(v['cells'])==1
for c in v['cells']:
