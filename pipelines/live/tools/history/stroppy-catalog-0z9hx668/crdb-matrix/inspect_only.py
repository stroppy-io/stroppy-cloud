...
if cell['database']=='ydb':
 # YDB emits tens of thousands of series per member. Stream original samples
...
print(json.dumps({'health':m['component_health'],'exporters':m['exporters'],'native':[x['measurements'] for x in n['segments']]},indent=2))
