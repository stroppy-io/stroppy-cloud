...
p=Path(sys.argv[1]);name=sys.argv[2];live=Path('/home/yaroher/devel/github/stroppy-io/stroppy-cloud/pipelines/live');parse=lambda s:datetime.datetime.fromisoformat(s.replace('Z','+00:00'))
