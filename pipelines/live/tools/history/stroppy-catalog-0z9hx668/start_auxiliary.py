...
p=Path('/tmp/stroppy-catalog-0z9hx668');old=p/'managed-queryready';dest=p/'auxiliary';cli='/tmp/stroppy-clusters-r1gx3otm/bin/graphenectl'
...
v=json.loads((dest/'suite.json').read_text());assert v['concurrency']==1 and len(v['cells'])==2
for c in v['cells']:
