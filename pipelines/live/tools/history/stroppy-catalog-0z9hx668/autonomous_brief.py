...
p=pathlib.Path('/tmp/stroppy-catalog-0z9hx668/ydb-autonomous');s=json.loads((p/'state.json').read_text());cli='/tmp/stroppy-catalog-0z9hx668/bin/graphenectl';print(datetime.datetime.now(datetime.timezone.utc).isoformat())
