...
p=Path(sys.argv[1]);name=sys.argv[2];live=Path('/tmp/stroppy-catalog-0z9hx668/log-filter-check-ppscz4ec/positive-26.1/live');parse=lambda s:datetime.datetime.fromisoformat(s.replace('Z','+00:00'))
