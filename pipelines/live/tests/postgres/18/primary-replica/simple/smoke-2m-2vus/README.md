# postgres 18 / primary-replica / simple / smoke-2m-2vus
...
|---|---|---|
| compile | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/10`) |
| infrastructure_provisioning | unknown | No explicit retained verification for this check. |
| smoke | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/10`) |
...
| component_metrics | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/10`) |
| component_logs | not_run | Not verified in the retained report. |
| pipeline_traces | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/10`) |
...
| cleanup | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/10`) |

Прогоны:

- [runs/matrix-pg-final-951a642e-pg18-primary-replica](runs/matrix-pg-final-951a642e-pg18-primary-replica/manifest.json)
