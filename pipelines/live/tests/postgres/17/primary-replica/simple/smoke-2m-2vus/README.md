# postgres 17 / primary-replica / simple / smoke-2m-2vus
...
|---|---|---|
| compile | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/7`) |
| infrastructure_provisioning | unknown | No explicit retained verification for this check. |
| smoke | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/7`) |
...
| component_metrics | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/7`) |
| component_logs | not_run | Not verified in the retained report. |
| pipeline_traces | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/7`) |
...
| cleanup | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/7`) |

Прогоны:

- [runs/matrix-pg-final-951a642e-pg17-primary-replica](runs/matrix-pg-final-951a642e-pg17-primary-replica/manifest.json)
