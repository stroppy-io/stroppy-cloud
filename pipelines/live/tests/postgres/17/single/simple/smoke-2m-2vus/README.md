# postgres 17 / single / simple / smoke-2m-2vus
...
|---|---|---|
| compile | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/8`) |
| infrastructure_provisioning | unknown | No explicit retained verification for this check. |
| smoke | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/8`) |
...
| component_metrics | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/8`) |
| component_logs | not_run | Not verified in the retained report. |
| pipeline_traces | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/8`) |
...
| cleanup | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/8`) |

Прогоны:

- [runs/matrix-pg-versions-ed460e6f-pg17-single](runs/matrix-pg-versions-ed460e6f-pg17-single/manifest.json)
