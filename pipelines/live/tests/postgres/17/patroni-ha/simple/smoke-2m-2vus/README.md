...
|---|---|---|
| compile | passed | [доказательство](../../../../../platform/catalog/patroni-matrix-check.json) (`/cells/0`) |
| infrastructure_provisioning | unknown | No explicit retained verification for this check. |
| smoke | passed | [доказательство](../../../../../platform/catalog/patroni-matrix-check.json) (`/cells/0`) |
...
| component_metrics | passed | [доказательство](../../../../../platform/catalog/patroni-matrix-check.json) (`/cells/0`) |
| component_logs | not_run | Not verified in the retained report. |
| pipeline_traces | passed | [доказательство](../../../../../platform/catalog/patroni-matrix-check.json) (`/cells/0`) |
...
| cleanup | passed | [доказательство](../../../../../platform/catalog/patroni-matrix-check.json) (`/cells/0`) |

Прогоны:

- [runs/matrix-patroni-96794a09-pg17-patroni-ha](runs/matrix-patroni-96794a09-pg17-patroni-ha/manifest.json)
