# postgres 16 / pgbouncer / simple / smoke-2m-2vus
...
|---|---|---|
| compile | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/3`) |
| infrastructure_provisioning | unknown | No explicit retained verification for this check. |
| smoke | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/3`) |
...
| component_metrics | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/3`) |
| component_logs | not_run | Not verified in the retained report. |
| pipeline_traces | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/3`) |
...
| cleanup | passed | [доказательство](../../../../../platform/catalog/postgres-matrix-check.json) (`/cells/3`) |

Прогоны:

- [runs/matrix-pg-final-951a642e-pg16-pgbouncer](runs/matrix-pg-final-951a642e-pg16-pgbouncer/manifest.json)
