> Исторический отчёт. Версии, статусы и команды ниже относятся к датам прогонов. Для текущей структуры см. [tests/README.md](../../README.md) и [tools](../../../tools/README.md). Старые имена файлов разрешаются через карту переноса.
...
файла [`native-export-check.json`](../catalog/native-export-check.json); входы —
[`suite-native-exports.json`](../suites/suite-native-exports.json) и
[`suite-native-tpcc-retry.json`](../suites/suite-native-tpcc-retry.json).
