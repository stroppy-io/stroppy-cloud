...
export interface SpecSuite1AwsSettingsNetworkCreate {
  kind: "create";
...
export interface SpecSuite1AwsSettingsNetworkExisting {
  kind: "existing";
...
/** def aws_settings */
export interface SpecSuite1AwsSettings {
  ...
  network?: SpecSuite1AwsSettingsNetworkCreate | SpecSuite1AwsSettingsNetworkExisting;
...
/** def baseline */
export interface SpecSuite1Baseline {
...
/** object pool */
export interface SpecSuite1DriverPool {
...
/** object postgres */
export interface SpecSuite1DriverPostgres {
  /** Max connections. Stroppy max_conns; unset preserves the driver default. */
  maxConns?: number | string | null;
  /** Min connections. Stroppy min_conns; unset preserves the driver default. */
  minConns?: number | string | null;
...
/** object sql */
export interface SpecSuite1DriverSql {
  /** Max open connections. Stroppy max_open_conns; unset preserves the driver default. */
  maxOpenConns?: number | string | null;
  /** Max idle connections. Stroppy max_idle_conns; unset preserves the driver default. */
  maxIdleConns?: number | string | null;
...
export interface SpecSuite1DriverInsertProgress {
...
/** def driver */
export interface SpecSuite1Driver {
...
export interface SpecSuite1RunProviderAws {
  kind: "aws";
  /** Settings. Baked provider placement settings. */
  settings: SpecSuite1AwsSettings;
...
export interface SpecSuite1RunProviderYandex {
  kind: "yandex";
  /** Settings. Baked provider placement settings. */
  settings: SpecSuite1YandexSettings;
  /** Credentials secret. Graphene secret name, never a credential value. */
  credentials_secret: string;
  /** ProviderConfig. Crossplane ProviderConfig used by the run. */
  provider_config_name: string;
...
/** object  */
export interface SpecSuite1RunNetworkItem {
  /** Port. */
  port: number | string;
  /** Protocol. */
  proto?: "tcp" | "udp";
...
/** object network */
export interface SpecSuite1RunNetwork {
  ...
  ingress?: Array<SpecSuite1RunNetworkItem>;
}

/** object managed_ydb */
export interface SpecSuite1RunManagedYdb {
...
/** object boot_disk */
export interface SpecSuite1RunItemBootDisk {
...
/** object  */
export interface SpecSuite1RunItemItem {
  /** Physical block size. YC physical block size in bytes (4096..131072 powers of two); omitted selects the smallest size that fits the disk. AWS does not expose this setting. [bytes] */
  block_size?: number | string;
  /** Device name. */
  name: string;
...
/** object  */
export interface SpecSuite1RunItem {
  /** Name. */
  name: string;
  ...
  boot_disk?: SpecSuite1RunItemBootDisk;
  ...
  disks?: Array<SpecSuite1RunItemItem>;
...
/** object  */
export interface SpecSuite1RunItem2Item {
  /** Container port. */
...
/** object  */
export interface SpecSuite1RunItem2Item2 {
  /** Host path. */
  source: string;
  /** Container path. */
  target: string;
...
/** object  */
export interface SpecSuite1RunItem2Item3 {
...
/** object healthcheck */
export interface SpecSuite1RunItem2Healthcheck {
  /** Command. */
  cmd: Array<string>;
  /** Interval. */
  interval?: string;
...
/** object  */
export interface SpecSuite1RunItem2 {
  /** Name. */
  name: string;
  ...
  machine: string;
  /** Kind. What the container is; the pipeline marks its record with it, so a topology view reads the kind instead of guessing from the image. */
  kind?: "database" | "proxy" | "coordinator" | "exporter" | "addon";
  ...
  /** Ports. */
  ports?: Array<SpecSuite1RunItem2Item>;
  /** Mounts. */
  mounts?: Array<SpecSuite1RunItem2Item2>;
  /** Files. Configs rendered by the server and injected at start. */
  files?: Array<SpecSuite1RunItem2Item3>;
  ...
  /** Health check. */
  healthcheck?: SpecSuite1RunItem2Healthcheck;
  /** Restart policy. */
...
/** object  */
export interface SpecSuite1RunItem3 {
  /** Role. */
  role: string;
...
/** object  */
export interface SpecSuite1RunItem4 {
  /** Role. */
  role: string;
...
/** object  */
export interface SpecSuite1RunItem5 {
  /** From role. */
  from_role: string;
...
/** object workload */
export interface SpecSuite1RunWorkload {
...
export interface SpecSuite1RunObservability {
...
/** def run */
export interface SpecSuite1Run {
  ...
  flows?: Array<SpecSuite1RunItem5>;
  /** Workload. What stroppy runs and where. */
  workload: SpecSuite1RunWorkload;
  /** Observability. */
  observability?: SpecSuite1RunObservability;
...
export interface SpecSuite1SegmentWorkloadBaseline {
  script: "baseline";
...
export interface SpecSuite1SegmentWorkloadExecuteSql {
  script: "execute_sql";
...
export interface SpecSuite1SegmentWorkloadSimple {
  script: "simple";
}

/** variant tpcb/procs of workload */
export interface SpecSuite1SegmentWorkloadTpcbProcs {
  script: "tpcb/procs";
...
export interface SpecSuite1SegmentWorkloadTpcbTx {
  script: "tpcb/tx";
  /** Scale factor. TPC-B scale factor = branches (scaleFactor); 100k accounts per branch. */
  scale_factor?: number | string;
  /** Load workers. Workers used to load each table (loadWorkers). */
...
export interface SpecSuite1SegmentWorkloadTpccProcs {
  script: "tpcc/procs";
...
export interface SpecSuite1SegmentWorkloadTpccTx {
  script: "tpcc/tx";
  /** Warehouses. Number of warehouses (scaleFactor); ~100 MB per warehouse drives the disk requirement. */
  scale_factor?: number | string;
  /** First warehouse. First warehouse id (warehouseStart); lets several runners share one database. */
...
export interface SpecSuite1SegmentWorkloadTpcds {
  script: "tpcds";
...
export interface SpecSuite1SegmentWorkloadTpchTx {
  script: "tpch/tx";
...
/** object run */
export interface SpecSuite1SegmentRun {
...
/** object thresholds */
export interface SpecSuite1SegmentThresholds {
...
/** def segment */
export interface SpecSuite1Segment {
  ...
  workload: SpecSuite1SegmentWorkloadBaseline | SpecSuite1SegmentWorkloadExecuteSql | SpecSuite1SegmentWorkloadSimple | SpecSuite1SegmentWorkloadTpcbProcs | SpecSuite1SegmentWorkloadTpcbTx | SpecSuite1SegmentWorkloadTpccProcs | SpecSuite1SegmentWorkloadTpccTx | SpecSuite1SegmentWorkloadTpcds | SpecSuite1SegmentWorkloadTpchTx;
  /** Scenario. Load shape of the segment. */
  run: SpecSuite1SegmentRun;
  ...
  thresholds?: SpecSuite1SegmentThresholds;
...
/** variant create of network */
export interface SpecSuite1YandexSettingsNetworkCreate {
  kind: "create";
...
/** variant existing of network */
export interface SpecSuite1YandexSettingsNetworkExisting {
  kind: "existing";
...
/** def yandex_settings */
export interface SpecSuite1YandexSettings {
  ...
  network?: SpecSuite1YandexSettingsNetworkCreate | SpecSuite1YandexSettingsNetworkExisting;
...
export interface SpecSuite1Item {
  ...
  id: string;
  /** RunSpec. A complete spec.run@1 value, validated before starting child runs. */
  run_spec: SpecSuite1Run;
}
