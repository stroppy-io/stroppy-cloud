// GENERATED from schemapb schema cfg.picodata.yaml@26.1 — do not edit.
// Picodata 26.x instance configuration (picodata.yaml): nested iproto/http/pgproto sections.

/** object  */
export interface CfgPicodataYaml26_1Item {
...
/** root */
export interface CfgPicodataYaml26_1 {
  ...
  tiers?: Array<CfgPicodataYaml26_1Item>;
